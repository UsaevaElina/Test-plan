...
1. Проверка позитивного кейса записи на курс
   ...
   1.3. Нажать на кнопку "Записаться". Запись на курс успешно осуществлена

2. Проверка отправки пустой формы
   
   1.1. Очистить все поля на форме заявки

   1.2. Нажать на кнопку "Записаться". Невозможно записаться на курс
...
8. Граничные значения в поле "Имя"
   ...
   1.6. Ввести в поле "Имя" значение из 64 букв
